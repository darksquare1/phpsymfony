...
class TaskController extends BaseApiController
{
    ...
    public function get_tasks(TaskRepository $taskRepository): JsonResponse
    {
        return $this->handleGetAll($taskRepository);
    }

    #[Route('/api/tasks/{id}', name: 'api_task', methods: ['GET'], format: 'json')]
    public function get_task(string $id, TaskRepository $taskRepository): JsonResponse
    {
        return $this->handleGet($id, $taskRepository);
    }

    #[Route('api/add/task', name: 'api_add_task', methods: ['POST'], format: 'json')]
    public function add_task(Request $request, EntityManagerInterface $em): JsonResponse
    {
    ...
    public function update_task(string $id, Request $request, EntityManagerInterface $em, TaskRepository $taskRepository): JsonResponse
    {
    ...
    public function delete_task(string $id, TaskRepository $taskRepository, EntityManagerInterface $em): JsonResponse
    {
